     ...
     <div>
        ...
        <div class="section">
            <div class="wrapper">
                <div class="wrap-box">
                    ...
                    <!--幻灯片-->
                    <div class="left-705">
                        <el-carousel hight="341px" :interval="5000" arrow="always">
        ...
        <div class="section" v-for="(item, index) in goodlist" :key="item.level1cateid">
            <div class="main-tit">
                ...
                <p>
                    <a href="/goods/43.html" v-for="(itSon, i) in item.level2catelist" :key="itSon.subcateid">{{itSon.subcatetitle}}</a>
            ...
            <div class="wrapper clearfix">
                <div class="wrap-box">
                    <ul class="img-list">
                        <li v-for="(temSon, i) in item.datas" :key="temSon.artID" >
                            <a href="#/site/goodsinfo/87" class="">
                                <div class="img-box">
                                    <img v-lazy="temSon.img_url">
                                </div>
                                <div class="info">
                                    <h3>{{temSon.artTitle}}</h3>
                                    <p class="price">
                                        <b>{{temSon.sell_price}}</b>元</p>
                                    <p>
                                        <strong>库存 {{temSon.stock_qantity}}</strong>
                                        <span>市场价：
                                            <s>{{temSon.market_price}}</s>
                                        </span>
                                    </p>
                                </div>
                            </a>
